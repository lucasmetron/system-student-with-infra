...
export default function Header({ onMenuToggle, isSidebarOpen }) {
  return (
    <header className="fixed top-0 left-0 lg:left-72 right-0 h-16 bg-surface-container-lowest/90 backdrop-blur-xl shadow-[0_1px_8px_rgba(0,0,0,0.04)] z-40 flex items-center justify-between px-5 sm:px-[40px] border-b border-surface-container/60 transition-all duration-300">
